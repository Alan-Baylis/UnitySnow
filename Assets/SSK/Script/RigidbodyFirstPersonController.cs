...
public class RigidbodyFirstPersonController : MonoBehaviour
{
    ...
    private void Start()
    {
        movementSettings.ForwardSpeed = ctManager.MoveSpeed;
        movementSettings.BackwardSpeed = movementSettings.ForwardSpeed / 2.0f;
        movementSettings.StrafeSpeed = movementSettings.ForwardSpeed / 2.0f;
        ...
        cam.GetComponent<HeadBob>().rigidbodyFirstPersonController = this;
    }
    ...
    private void FixedUpdate()
    {
        ...
        if (m_IsGrounded)
        {
            ...
            if (input.magnitude != 0)
                ctManager.playWalkingSound();
            else
                ctManager.stopWalkingSound();
        }
        else
        {
            m_RigidBody.drag = 0f;
    ...
    private void GroundCheck()
    {
            ...
            Physics.AllLayers))//, QueryTriggerInteraction.Ignore))
        {
            ...
            ctManager.BottomObject = hitInfo.transform.gameObject;
            ctManager.BottomObject = ctManager.BottomObject;
